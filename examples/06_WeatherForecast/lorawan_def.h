...
#define STRUCT_H
	...
	*/
	...
	typedef struct 
	{
		...
		{
		// Change hex values in line below to your Network Session Key in msb order
		.NwkSKey = {0x01, 0x23, 0x45, 0x67, 0x89, 0x01, 0x23, 0x45, 0x67, 0x89, 0x01, 0x23, 0x45, 0x67, 0x89, 0x10},	
		// Change hex values in line below to your App Session Key in msb order
    .AppSKey = {0x01, 0x23, 0x45, 0x67, 0x89, 0x01, 0x23, 0x45, 0x67, 0x89, 0x01, 0x23, 0x45, 0x67, 0x89, 0x10},
		// Change hex values in line below to your Device Address in msb order
		.DevAddr = {0x01, 0x23, 0x45, 0x67},
