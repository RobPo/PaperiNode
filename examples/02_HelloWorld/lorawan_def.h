...
#define STRUCT_H
	...
	*/
	...
	typedef struct 
	{
		...
		{
		.NwkSKey = {0x01, 0x23, 0x45, 0x67, 0x89, 0x01, 0x23, 0x45, 0x67, 0x89, 0x01, 0x23, 0x45, 0x67, 0x89, 0x10},	// Change this to your own key
        .AppSKey = {0x01, 0x23, 0x45, 0x67, 0x89, 0x01, 0x23, 0x45, 0x67, 0x89, 0x01, 0x23, 0x45, 0x67, 0x89, 0x10},	// Change this to your own key
		.DevAddr = {0x01, 0x23, 0x45, 0x67},																			// Change this to your own key
		.frame_counter_down = 0,
			.frame_counter_up   = 0,
			.Receive_delay		= RECEIVE_DELAY2,
			.Transmit_Power     = 0x0F,
			.TxChDr = {SF07BW125kHz, CH00_868_100},
